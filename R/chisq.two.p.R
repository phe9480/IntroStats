...
#' it is always right-sided, however it is equivalent to two-sided test in Z test.
...
#' @param conflev Level of confidence interval, default 0.95
...
#' chisq.two.p(r1=107, n1=245, r2=52, n2=232, correct=TRUE, alpha=0.05, conflev = 0.95)
#' 
#' chisq.two.p(r1=6, n1=245, r2=38, n2=232, correct=TRUE, alpha=0.05, conflev = 0.95)
#' 
#' @export 
#'
chisq.two.p <- function(r1, n1, r2, n2, correct=TRUE, alpha=0.05, conflev = 0.95,...){
