...
#' @examples
#'
#' ci.p(r=4, n=20, conflev=0.95, method="Clopper-Pearson Exact")
#' ci.p(r=4, n=20, conflev=0.95, method="Wilson Score")
#' ci.p(r=4, n=20, conflev=0.95, method="Wilson Score with Continuity")
#' ci.p(r=4, n=20, conflev=0.95, method="Asymptotic Normal")
#' ci.p(r=4, n=20, conflev=0.95, method="Asymptotic Normal with Continuity")
#'
#' @export
#'
ci.p = function(r, n, conflev, method="Clopper-Pearson Exact"){
  #1.
